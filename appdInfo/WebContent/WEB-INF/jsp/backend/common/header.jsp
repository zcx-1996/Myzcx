        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="${pageContext.request.contextPath }/dev/Backlogout.do">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="${pageContext.request.contextPath }/dev/Backlogin.do"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
